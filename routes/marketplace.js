const { getMarketItems, buyitem, buychest, sellitem, equipitem, unequipitem, listequippeditems, claimfreebie, buypack } = require('../controllers/marketplace');
...
router
 ...
 .post("/buypack", protectplayer, buypack)
